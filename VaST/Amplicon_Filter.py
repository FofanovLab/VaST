...
class AmpliconFilter:
            ...
            while go:
                ...
                if amplicon is None:
                    ...
                    if current_site == last_site:
                        ...
                        current_site = sites.iloc[pos].Start
                    continue
                self.update_pattern(amplicon, pos)
                if len(amplicon) == 1:
                    pos += 1
                else:
    ...
    def update_pattern(self, amplicon, position):
        ...
        if not self._strict:
            ...
            if np.all(
                ...
                self._patterns.add_unambiguous_amplicon(sites, amplicon)
            else:
                self._patterns.add_ambiguous_amplicon(sites, amplicon)
